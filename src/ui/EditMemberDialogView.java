...
public class EditMemberDialogView extends JDialog implements Validator {
    ...
    private void initListener() {
        ...
        update.addActionListener(__ -> {
            ...
            dto.setGender(MEMBER_GENDER_LIST[genderComBox.getSelectedIndex()]);
    ...
    public String valid() {
        ...
        if(DEFAULT_MEMBERS[0].getRoleName().equals(memberTextField.getText())) {
            map.put("Age", new Validation(yourAgeValue.getText(), ValidationEnum.GREATER_THAN_12));
        } else if(DEFAULT_MEMBERS[1].getRoleName().equals(memberTextField.getText())) {
