...
public class RoleTable extends MyTable implements DataSourceChannel<RoleDto> {
    ...
    private void initMyEvents() {
        ...
        this.helpBtn.addActionListener(e ->
                JOptionPane.showMessageDialog(this.jScrollPane, HELP_INFO[2], "Help", JOptionPane.QUESTION_MESSAGE, MyImageIcon.build(TABLE_TOOL_LIST[9][1])));
    }
    ...
    private void fetchData() {
        ...
        model.setDataVector(RoleService.findRoles(), ROLE_COLUMNS);
